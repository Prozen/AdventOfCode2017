fun main(args: Array<String>) {
    val lines = """una bokpr ftz ryw nau yknf fguaczl anu
...
lpyubo dylpfb iehwug decj ntidy cuygyg lalkb iutu oxgm imn""".lines()

    print(lines.count(::isValid))

}

fun isValid(s: String): Boolean {
    val split = s.split(" ")
    return split.size == split.map { it.toCharArray().sorted() } .distinct().size
}
